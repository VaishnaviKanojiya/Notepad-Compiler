...
public class CodeEditorGUI {
	...
	JMenuItem javaItem,cItem,cppItem,pythonItem,htmlItem ,cssItem;
	...
	public void createLanguageMenuItem()
	{
		...
		cssItem = new JMenuItem("CSS") ;
			
		languageMenu.add(cssItem) ;
	...
	public void setLanguage(String lang)
	{
		...
		case "Java":
		{
			path = "D:\\internship\\java.txt" ;
		}
			
			break;
			case "C":
		{
			path = "D:\\internship\\c.txt" ;
		}
			break ;
			case "C++" :
		{
			path = "D:\\internship\\cpp.txt" ;
		}
			break ;
			case "HTML":
		{
			path = "D:\\internship\\html.txt" ;
		}
			break ;
			case "Python":
		{
			path = "D:\\internship\\python.txt" ;
		}
			break ;
			
			case "CSS" :
		{
			path = "D:\\internship\\css.txt" ;
		}
			break ;
		}
